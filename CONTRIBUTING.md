# Contributing to angular-utils project
...
submitting an issue to my [GitHub Repository](https://github.com/XavierBoubert/angular-utils/issues). Even better you can submit a Pull Request
with a fix.

**Please see the Submission Guidelines below**.

## <a name="feature"></a> Want a Feature?
You can request a new feature by submitting an issue to my [GitHub Repository](https://github.com/XavierBoubert/angular-utils). If you
...
* **Small Changes** can be crafted and submitted to the [GitHub Repository](https://github.com/XavierBoubert/angular-utils) as a Pull Request.
...
* Search [GitHub pulls](https://github.com/XavierBoubert/angular-utils/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `angular-utils:master`.
...
Only the lead contribution team can publish a new version. To do that, it requires that the milestone is completely finished ([Milestones](https://github.com/XavierBoubert/angular-utils/issues/milestones?state=open)).
